...
class Ransac{
  ...
  public :
    ...
    Ransac(std::tuple< std::vector<cv::KeyPoint> , std::vector<cv::KeyPoint> , std::vector<cv::DMatch> , bool > datapoint , uint64_t n , float error , float w , Frame*  ptr_f, cv::Matx33f R, cv::Matx31f T , cv::Matx33f K_g , cv::Matx33f K_d , float f);
    ~Ransac(void);
